...
def params(parser):
    ...
    parser.add_argument(
        "--present_day_climate_file",
        type=str,
        default="present_day_climate.nc",
        help="Name of the atmosphere input file for the climate outide the given datatime frame (time, delta_temp, prec_scali)",
    )
    parser.add_argument(
        "--delta_temp_greenland_composite",
        type=str,
        default="greenland_core_composite.nc",
        help="Name of the greenland ice core composite delta temperature input file",
    )
    parser.add_argument(
        "--delta_temp_antarctic_composite",
        type=str,
        default="antarctic_core_composite.nc",
