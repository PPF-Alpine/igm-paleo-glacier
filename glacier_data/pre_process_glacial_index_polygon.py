...
def check_available_files():
    ...
    if not Path("antarctica_core_composit/antarctica_core_composit.tab").exists():
        raise Exception("antactrica ice core data is required.")

    if not Path("greenland_core_composite/greenland_core_composite.tab")
        raise Exception("greenland ice core data is required.")
